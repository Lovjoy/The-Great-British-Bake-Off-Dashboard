...
* **Handshake distribution by gender and age:** The show had a fairly balanced gender distribution, with slightly more female bakers overall. However, male bakers received **29 handshakes**, compared with **22 handshakes received by 17 female bakers**. Overall baker age distribution was highest in the **30 age bin**, while handshake frequency peaked in the **25 age bin**. Within the 25 age bin, female bakers received **11 handshakes**, compared with **5 handshakes** received by male bakers. Female handshake recipients were most concentrated in the **25 to 30 age bins**, accounting for **13 of the 17 female bakers who received handshakes**.
